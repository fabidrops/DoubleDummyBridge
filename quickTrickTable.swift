...
func calQuickTricks(topCards: UInt8, a: Int, b:Int, oppMax:Int, LHO: [Bool]) -> Int {
    ...
    case 0b10000010: // A zu Q
        ...
        if a == 1 { return 1 }
            //TO DO : oppMax <= 1 ist zu streng , SinglE-K reicht
...
//    // dritte Zahl Übergänge nach West wenn man Maximum Stiche macht
//    // vierte Zahl Übergäbge nach Ost wenn man Maximum Stiche rausholt
//    
//    var tricksFromWest = 0
//    var tricksFromEast = 0
//    
//    var WestEqualsEast = true
//    
//    switch topCards {
//        
//        // die Fälle wo egal ist ob West oder Ost sollte man ncht differenzieren
//        // der Fall b=0 muss gesondert abgefangen werden
//        
//    case 0b11110000: // AKQJ zu -
//        
//        if oppMax <= 4 {tricksFromWest = a} else {tricksFromWest = 4}
//        
//        if b > 0 {tricksFromEast = tricksFromWest} else {tricksFromEast = 0 }
//        
//    case 0b11100001: // AKQ zu J
//        
//        // 1. von wo wird gespielt, 2. Entry Situation , qT (a,b,maxOpps,LHO,RHO)
//        
//        // W,E0,3,1-3,x,x,x
//        
//        
//        // 3 x Brücke von Ost nach West
//        
//        // AKQ - J,Jx,Jxx
//        
//            // 3
...
//        // AKQ - Jxxx+
//        
//            // was brauche ich ? Ein Entry E->W
//        
//            // ws gebe ich dann ? Ein Entry von W->E
//        
//            // W->E
//        
//            // 3 ohne Entry zu E egal von wo spielend
//        
//            // b mit Entry zu E und maxO <= 4
//        
//            // 4 mit Entry zu E und maxO > 4
//        
//        // AKQx+ - J
//        
//            //
...
//        // AKQx+ - Jx+
//        
//        if a == 3 { tricksFromWest = 3 } // AKQ sec
//        else {
//            
//            if b == 1 { // AKQx(xx) - J
//                
//                if oppMax <= 3 { tricksFromWest = a } else { tricksFromWest = 3 }
//                
//            } else { // AKQx(xx) - Jx(xxx)
//                
//                if oppMax <= 4 { tricksFromWest = max(a,b) } else { tricksFromWest = 4 }
//                
//            }
//            
//        }
//        
//        tricksFromEast = tricksFromWest
//        
//    case 0b11100000: // AKQ zu -
//        
//        if b <= 3 && oppMax <= 3 { return a }
